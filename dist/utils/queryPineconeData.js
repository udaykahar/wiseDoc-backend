...
exports.queryPineconeData = void 0;
...
dotenv.config();
const queryPineconeData = (query) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const response = yield chain.call({ query });
    console.log(response);
    return response;
});
exports.queryPineconeData = queryPineconeData;
